...
class ActivityType:
    ...
    FRIENDLY_MAP = {
        LOGIN: LOGIN_FRIENDLY,
        LOGOUT: LOGOUT_FRIENDLY,
        REQUEST_SENT: REQUEST_SENT_FRIENDLY,
        REQUEST_CHANGED: REQUEST_CHANGED_FRIENDLY,
        ...
        GLOBAL_SETTING_CHANGED: GLOBAL_SETTING_CHANGED_FRIENDLY,
    }
